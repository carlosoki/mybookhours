...
class WebApiContext extends BaseApiContext implements Context
{
    ...
    public function gatherContexts(BeforeScenarioScope $scope)
    {
        ...
        $this->oauthContext = $environment->getContext('Persuit\GlobalFeatures\OauthContext');
        $this->userContext = $environment->getContext('Persuit\GlobalFeatures\UserContext');
    }
