...
namespace spec\Project\Bundle\Api\Entity;
...
class ProfileQueryBuilderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Project\Bundle\Api\Entity\ProfileQueryBuilder');
    }
    ...
    public function it_can_create_a_query($qb)
    {
        ...
        $qb->from('Project\Bundle\Api\Entity\Profile', 'p')->shouldBeCalled();
