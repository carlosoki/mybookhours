...
Feature: Add a new LegalEntity or update an existing LegalEntity
  ...
  Background:
    ...
    Scenario Outline:
      ROLE_ADMIN can view/update/create any LegalEntity
      ...
      Examples:
        ...
        | userwriter.dlapiper@sink.sendgrid.net | 123      | GET    | legal_entity/1 | {}   | 200  |
        | userwriter.dlapiper@sink.sendgrid.net | 123      | GET    | legal_entities | {}   | 200  |
        | userwriter.dlapiper@sink.sendgrid.net | 123      | PUT    | legal_entity/1 | {}   | 403  |
        | userwriter.dlapiper@sink.sendgrid.net | 123      | POST   | legal_entity   | {}   | 403  |
        | admin.persuit@sink.sendgrid.net       | 123      | GET    | legal_entity/1 | {}   | 200  |
        | admin.persuit@sink.sendgrid.net       | 123      | GET    | legal_entities | {}   | 200  |
